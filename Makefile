...
p2v: p2v_utils.o p2v_input_reader.o p2v.o p2v_parameters.o p2v_chromosome.o
	$(CC) $(LDFLAGS) -o p2v p2v_utils.o p2v_input_reader.o p2v.o p2v_parameters.o p2v_chromosome.o
